...
--pheno $WorkingDir/heritability/input_files/pheno_ugli_cyto_foreign_accents_understanding_cogn_filtered.txt \
...
--reml-no-constrain \
--out $WorkingDir/heritability/output_files/SNPh2.bK02.UGLI1and2.CYTO.foreign_accents_understanding_cogn_filtered \
--thread-num 10
