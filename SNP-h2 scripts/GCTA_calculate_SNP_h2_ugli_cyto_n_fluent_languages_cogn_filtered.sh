...
# Binary heritability
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# for ugli2, gsa and cyto.

gcta64 \
--mgrm $WorkingDir/GRMs/GRMs_ugli2_gsa_cyto/bK/GRM.bK.02.mgrm.txt \
--pheno $WorkingDir/heritability/input_files/pheno_ugli_cyto_n_fluent_languages_cogn_filtered.txt \
--covar $WorkingDir/heritability/input_files/covar_binary_ugli1and2_cyto_cogn_filtered.txt \
--qcovar $WorkingDir/heritability/input_files/covar_ugli_cyto_quant_ugli1and2_n_fluent_languages_cogn_filtered.txt \
--reml-no-constrain \
--out $WorkingDir/heritability/output_files/SNPh2.bK02.UGLI1and2.CYTO.n_fluent_languages_cogn_filtered \
--thread-num 10
