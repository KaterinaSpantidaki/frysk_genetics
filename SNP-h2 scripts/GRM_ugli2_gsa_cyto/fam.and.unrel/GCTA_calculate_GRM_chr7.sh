...
gcta64 --bfile $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/7.All.filtered \
       --chr 7 \
       --make-grm \
       --out $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/GRM.7.All.filtered \
       --thread-num 10
