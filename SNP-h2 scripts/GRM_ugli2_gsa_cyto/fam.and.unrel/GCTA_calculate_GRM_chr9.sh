...
gcta64 --bfile $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/9.All.filtered \
       --chr 9 \
       --make-grm \
       --out $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/GRM.9.All.filtered \
       --thread-num 10
