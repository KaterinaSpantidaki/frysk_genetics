...
gcta64 --bfile $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/4.All.filtered \
       --chr 4 \
       --make-grm \
       --out $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/GRM.4.All.filtered \
       --thread-num 10
