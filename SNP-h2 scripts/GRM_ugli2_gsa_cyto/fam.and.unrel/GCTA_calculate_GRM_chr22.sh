...
gcta64 --bfile $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/22.All.filtered \
       --chr 22 \
       --make-grm \
       --out $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/GRM.22.All.filtered \
       --thread-num 10
