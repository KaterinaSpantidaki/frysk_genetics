...
gcta64 --bfile $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/3.All.filtered \
       --chr 3 \
       --make-grm \
       --out $WorkingDir/GRMs_ugli2_gsa_cyto/All_intermediate_files/GRM.3.All.filtered \
       --thread-num 10
