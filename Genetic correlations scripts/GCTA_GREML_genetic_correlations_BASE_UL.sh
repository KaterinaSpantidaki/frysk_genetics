...
gcta64 \
 ...
 --pheno $WorkingDir/gen_cor/input_files/pheno_ugli_cyto_bivar_cogn_filtered_UL.txt \
 --covar $WorkingDir/gen_cor/input_files/covar_binary_ugli1and2_cyto_bivar_cogn_filtered_UL.txt \
 --qcovar $WorkingDir/gen_cor/input_files/covar_quant_ugli1and2_cyto_bivar_cogn_filtered_UL.txt \
 --thread-num 10 \
 --out $WorkingDir/gen_cor/output_files/GREML_bivar.bk02_cogn_filtered_UL
